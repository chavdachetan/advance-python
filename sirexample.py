...
def Save_Records():
    ...
    if(nm=="" or pr == ""):
        ...
        tree.insert("",END,values=(lastrow,nm,pr))
        e1.delete(0,END)
        e2.delete(0,END) 
        messagebox.showinfo("information","RECORD INSERTED SUCCESSFULL.")
...
def delete_record():
    ...
    if(get_id["values"]==""):
        ...
        mes=messagebox.askquestion("Warning","Do You Want To Delete This Record?")
        if(mes=="yes"):
